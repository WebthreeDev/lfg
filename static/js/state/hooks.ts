...
export const useBTCBusdPrice = (): BigNumber => {
  const pid = 10 // CAKE-BNB LP
  const bnbPriceUSD = usePriceBnbBusd()
  const farm = useFarmFromPid(pid)
  console.log('useBTCBusdPrice', bnbPriceUSD.div(farm.tokenPriceVsQuote).toNumber())

  return farm.tokenPriceVsQuote ? bnbPriceUSD.div(farm.tokenPriceVsQuote) : ZERO
  // return ZERO
}
